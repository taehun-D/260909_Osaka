...
const ITEMS = [
  ...
  { jp: "サラサーティ コットン100 2枚重ね 72枚入",
    ...
    ko: "팬티라이너 코튼100% 72매",
    code: "", yen: 0, img: "sarasaty.jpg", cat: "드럭스토어", pri: "B" },
  ...
  { jp: "リーメント くじポン! Hello Kitty SURPRISE MIX!",
    ...
    ko: "블라인드 박스 식완",
    code: "", yen: 1650, img: "", cat: "오타쿠 굿즈", pri: "A" },
  { jp: "ぷちサンプルシリーズ 昭和の駄菓子屋",
    yomi: "푸치산푸루 시리즈 쇼와노 다가시야",
    ko: "미니어처 세트, 박스 단위",
    code: "", yen: 4400, img: "", cat: "오타쿠 굿즈", pri: "B" },
  { jp: "ねんどろいど",
    yomi: "넨도로이도",
    ko: "중고 매대 확인",
    code: "", yen: 3000, img: "", cat: "오타쿠 굿즈", pri: "C" },
  { jp: "figma",
    yomi: "피구마",
    ko: "가동 피규어",
    code: "", yen: 7800, img: "", cat: "오타쿠 굿즈", pri: "B" },
  { jp: "アクリルスタンド",
    yomi: "아쿠리루 스탄도",
    ko: "아크릴 스탠드",
    code: "", yen: 1200, img: "", cat: "오타쿠 굿즈", pri: "C" },
  { jp: "ナノブロック",
    yomi: "나노부록쿠",
    ko: "나노블록",
    code: "", yen: 2200, img: "", cat: "오타쿠 굿즈", pri: "B" },
  { jp: "食玩",
    yomi: "쇼쿠간",
    ko: "식완 코너 신상 확인",
    code: "", yen: 3000, img: "", cat: "오타쿠 굿즈", pri: "A" },
  { jp: "サンリオ ぬいぐるみ",
    yomi: "산리오 누이구루미",
    ko: "산리오 인형",
    code: "", yen: 3300, img: "", cat: "오타쿠 굿즈", pri: "B" },
  ...
  { jp: "立つしゃもじ",
    yomi: "타츠 샤모지",
    ko: "세워지는 밥주걱 · 밥알 안 붙음",
    code: "", yen: 0, img: "shamoji.jpg", cat: "잡화", pri: "B" }
];
